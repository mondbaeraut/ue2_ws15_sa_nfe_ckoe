    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            props = new PropertyDescriptor[]{
                    new PropertyDescriptor("radius", OpeningBean.class),
            };
    ...
    public MethodDescriptor[] getMethodDescriptors() {
        ...
        try {
            props = new MethodDescriptor[]{
                    new MethodDescriptor(OpeningBean.class.getMethod("onImage", ImageEvent.class))
            };
    ...
    public EventSetDescriptor[] getEventSetDescriptors() {
        ...
        try {
            props = new EventSetDescriptor[]{
                    new EventSetDescriptor(OpeningBean.class, "image", ImageListener.class, "onImage")
            };
        } catch (IntrospectionException e) {
            e.printStackTrace();
